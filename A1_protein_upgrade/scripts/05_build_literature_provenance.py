...
REQUIRED_COLUMNS = [
    ...
    "replication_status", "effect_direction", "outcome_GWAS", "overlap_with_current_A1_outcome",
    ...
    for platform, mr_sheet, coloc_sheet, subtype, outcome in specs:
        ...
        for index, value in mr.iterrows():
            ...
            row = base_row(
                ...
                outcome_GWAS=outcome, overlap_with_current_A1_outcome="same_FinnGen_resource_different_release_R10_vs_R12",
...
def extract_belbasis() -> list[dict[str, object]]:
    ...
    for index, value in mr.iterrows():
        ...
        row = base_row(
            ...
            overlap_with_current_A1_outcome="likely_overlap_with_Wightman_2021_components",
...
def extract_zhan() -> list[dict[str, object]]:
    ...
    for index, value in primary.iterrows():
        ...
        row = base_row(
            ...
            overlap_with_current_A1_outcome="Bellenguez_partially_overlaps_Wightman_components; FinnGen_independent_of_current_AD",
...
def extract_zhou() -> list[dict[str, object]]:
    ...
    for index, value in mr.iterrows():
        ...
        row = base_row(
            ...
            overlap_with_current_A1_outcome="partially_overlaps_or_reuses_components_of_Wightman_2021",
            same_outcome_reanalysis="possible", assay_cross_reactivity_risk="SomaScan assay mapping review required",
            notes="Source-paper tier was not copied automatically; raw FDR, coloc and replication fields drive A1 tiering.",
...
def extract_hou() -> list[dict[str, object]]:
    ...
    for index, value in data.iterrows():
        ...
        row = base_row(
            ...
            outcome_GWAS="FinnGen R11 and MVP", overlap_with_current_A1_outcome="same_FinnGen_resource_different_release_R11_vs_R12",
...
def extract_li_ocular() -> list[dict[str, object]]:
    ...
    for index, value in mr.iterrows():
        ...
        row = base_row(
            ...
            outcome_GWAS="ocular disease GWAS listed in Table S1", overlap_with_current_A1_outcome="requires_manual_verification",
    ...
    for sheet, platform, subtype in specs:
        ...
        for index, value in data.iterrows():
            ...
            row = base_row(
                ...
                overlap_with_current_A1_outcome="requires_manual_verification", same_outcome_reanalysis="unclear",
                assay_cross_reactivity_risk="requires_platform_review",
...
def extract_zhao() -> list[dict[str, object]]:
    ...
    for index, value in data.iterrows():
        ...
        row = base_row(
            ...
            overlap_with_current_A1_outcome="different_outcome_GWAS_from_current_A1",
    ...
    for sheet in ["S2", "S3", "S4", "S5", "S6", "S7"]:
        ...
        for index, value in subset.iterrows():
            ...
            row = base_row(
                ...
                overlap_with_current_A1_outcome="likely_overlap_with_current_AD_GWAS_components",
